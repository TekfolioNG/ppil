          ...
          <div class="lg:w-1/2">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                <input type="hidden" name="access_key" value="4f2cc9d2-1916-417e-9062-5bffec3761a0">
                <input type="hidden" name="redirect" value="https://ppil.com.ng/thank-you">
                <input type="hidden" name="subject" value="New Contact Form Submission from PPIL Website">
                <input type="hidden" name="from_name" value="PPIL Website Contact Form">
                <input type="hidden" name="to" value="info@ppil.com.ng">
